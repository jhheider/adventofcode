...
pub fn main() {
    ...
    println!("Day 17: Test: {} unique combinations", test_out.0);

    let part1 = solve(containers, 150);
    assert_eq!(part1.0, 4372);
    println!("Day 17: Part 1: {} unique combinations", part1.0);

    assert_eq!(test_out.1, 3);
    println!("Day 17: Test: {} permuatations", test_out.1);

    assert_eq!(part1.1, 4);
    println!("Day 17: Part 2: {} unique combinations", part1.1);
}
