pub fn main() {
    ...
    assert_eq!(test1, 8);
    println!(
        "Day 20: Test 1: the first house to have {} presents is #{}",
        test, test1
    );
    ...
    println!(
        "Day 20: Part 1: the first house to have {} presents is #{}",
        input, part1
    );
    ...
    assert_eq!(test2, 8);
    println!(
        "Day 20: Test 2: the first house to have {} presents is #{}",
        test, test2
    );
    ...
    println!(
        "Day 20: Part 2: the first house to have {} presents is #{}",
        input, part2
    );
}
