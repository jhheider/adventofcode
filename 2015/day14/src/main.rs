...
fn main() {
    ...
    println!("Test 1: winner is at {}km", test1);

    let part1 = compute(&input, 2503, false);
    assert_eq!(part1, 2640);
    println!("Part 1: winner is at {}km", part1);

    let test2 = compute(&test, 1000, true);
    assert_eq!(test2, 689);
    println!("Test 2: winner is at {} points", test2);

    let part2 = compute(&input, 2503, true);
    assert_eq!(part2, 1102);
    println!("Part 2: winner is at {} points", part2);
}
